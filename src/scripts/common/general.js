  ...
  return data
    .map(
      ({
        ...
        strDrink,
        idDrink,
      }) => `<li id="cocktail-${idDrink}" class="gallery-item">
    ...
    src="${strDrinkThumb}" alt="${strDrink} photo" />
      ...
      <div class="button-container">
        ...
        <button class="button-favorite" data-cocktailid="${idDrink}" data-add-remove-favorite="" data-element-type="cocktail" type="button">
          <span>Add to</span>
...
export function markupGalleryTwo(data) {
  return data
    .map(
