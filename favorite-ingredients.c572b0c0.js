 ...
 * limitations under the License.
 */
class Pn{static credential(e,t){return Tn._fromEmailAndPassword(e,t)}static credentialWithLink(e,t){const n=Nn.parseLink(t);return wt(n,"argument-error"),Tn._fromEmailAndCode(e,n.code,n.tenantId)}constructor(){this.providerId=Pn.PROVIDER_ID}}Pn.PROVIDER_ID="password",Pn.EMAIL_PASSWORD_SIGN_IN_METHOD="password",Pn.EMAIL_LINK_SIGN_IN_METHOD="emailLink";
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
di("rcb"),new Pt(3e4,6e4);async function fi(e,t,n){var i;const r=await n.verify();try{let s;if(wt("string"==typeof r,e,"argument-error"),wt("recaptcha"===n.type,e,"argument-error"),s="string"==typeof t?{phoneNumber:t}:t,"session"in s){const t=s.session;if("phoneNumber"in s){wt("enroll"===t.type,e,"internal-error");const n=await
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class oo{reportStats_(){const e=this.statsListener_.get(),t={};let n=!1;Tr(e,((e,i)=>{i>0&&Q(this.statsToReport_,e)&&(t[e]=i,n=!0)})),n&&this.server_.reportStats(t),Nr(this.reportStats_.bind(this),Math.floor(2*Math.random()*3e5))}constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new so(e);const n=1e4+2e4*Math.random();Nr(this.reportStats_.bind(this),Math.floor(n))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Io{static empty(){return new Io(new To(null))}constructor(e){this.writeTree_=e}}function So(e,t,n){if(ss(t))return new Io(new To(n));{const i=e.writeTree_.findRootMostValueAndPath(t);if(null!=i){const r=i.path;let s=i.value;const o=os(r,t);return s=s.updateChild(o,n),new Io(e.writeTree_.set(r,s))}{const i=new To(n),r=e.writeTree_.setTree(t,i);return new Io(r)}}}function ko(e,t,n){let i=e;return Tr(n,((e,n)=>{i=So(i,rs(t,e),n)})),i}function Ro(e,t){if(ss(t))return Io.empty();{const n=e.writeTree_.setTree(t,new To(null));return new Io(n)}}function No(e,t){return null!=Po(e,t)}function Po(e,t){const n=e.writeTree_.findRootMostValueAndPath(t);return null!=n?e.writeTree_.get(n.path).getChild(os(n.path,t)):null}function Ao(e){const t=[],n=e.writeTree_.value;return null!=n?n.isLeafNode()||n.forEachChild(As,((e,n)=>{t.push(new ps(e,n))})):e.writeTree_.children.inorderTraversal(((e,n)=>{null!=n.value&&t.push(new ps(e,n.value))})),t}function Lo(e,t){if(ss(t))return e;{const n=Po(e,t);return new Io(null!=n?new To(n):e.writeTree_.subtree(t))}}function Oo(e){return e.writeTree_.isEmpty()}function xo(e,t){return Do(Jr(),e.writeTree_,t)}function Do(e,t,n){if(null!=t.value)return n.updateChild(e,t.value);{let i=null;return t.children.inorderTraversal(((t,r)=>{".priority"===t?(b(null!==r.value,"Priority writes must always be leaf nodes"),i=r.value):n=Do(rs(e,t),r,n)})),n.getChild(e).isEmpty()||null===i||(n=n.updateChild(rs(e,".priority"),i)),n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
